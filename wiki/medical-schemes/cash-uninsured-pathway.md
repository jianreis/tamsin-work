...
- **Public CCMDD**: the uninsured chronic patient's free route — collect
  ...
  [[src-sch-ccmdd-public]]). Retail pharmacies serve as CCMDD pick-up points.
...
be a meaningful share of monthly income; the dispensing fee is proportionally
...
- **Dignity and parity.** Cash patients get the *same* medicine; the UX should
