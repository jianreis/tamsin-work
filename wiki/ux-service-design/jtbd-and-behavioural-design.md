...
- **Easy** — harness **defaults** (opt-out auto-refill for chronic scripts);
...
- **Defaults** are among the strongest levers — pre-selecting a beneficial option
  ...
  dramatically raises uptake [[src-ux-east-behavioural-insights]].
...
- **Sludge** = friction with bad intent (hard-to-cancel, buried opt-outs, repeated
  ...
  in health this is also an ethics/trust failure [[src-ux-sludge-thaler-sunstein]]
...
[[src-ux-text-reminder-adherence-meta]]. Note: reminders fix *forgetting*
