...
**work, modestly and conditionally** — useful, not magic.
...
The honest summary: reminder and monitoring technology reliably **nudges adherence
...
for **sustained engagement**, not novelty — the meta-analytic caveats are mostly
about durability and rigour.

## Smart packaging, sensors and remote monitoring

Smart packaging spans simple **reminder/blister packaging** (proven, cheap) through
...
- **Channel reality:** SA adherence nudges should ride **SMS/WhatsApp/USSD and
  ...
  `consumer-context`).
- **POPIA:** adherence/monitoring data is health data — consent and data-protection
...
- **DTx regulation:** SAHPRA classification of software-as-medical-device DTx in SA
  is uncertain — verify before any therapeutic claim.

## Design implications

- **Lead with proven, cheap interventions** (reminder/blister packaging, simple
...
- **Design for sustained engagement**, since evidence shows effect but uncertain
  durability — avoid one-off novelty features.
- **Don't over-claim AI adherence coaching** — evidence is weak; frame as
