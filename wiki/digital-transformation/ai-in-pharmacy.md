...
accuracy across varied phrasings [[src-dig-cv-pill-triage]]. That makes it usable for
...
chain, prior authorisation, documentation, surfacing care gaps, but **not** autonomous
...
Hallucination, meaning confident fabrication, is the defining LLM risk in clinical
text. Liability for an AI-influenced dispensing error ultimately tracks to the responsible
...
since AI inventory/CDS quality depends on clean, integrated data SA's fragmented records
often lack ([[interoperability-identity-records]]); (2) **POPIA**, since any patient-data
AI must satisfy consent and data-protection rules; and (3) **accountability**, since SAPC
...
- **Map AI by autonomy, not by buzzword.** Proven/assistive (CDS, forecasting,
  vision) deploy now under oversight. Agentic AI handles orchestration of admin/refill
...
- **Design the agent to assemble, the human to authorise:** for example, a refill agent
...
- **Don't over-promise adherence AI:** frame it as supportive, evidence still weak.
