...
visual/icon-based** dosage and status communication is not a nicety — it is a
clinical-safety and adherence lever.
...
first/only clinician an uninsured person can reach without an appointment or fee —
...
- **Mental health:** ~**75% treatment gap** for common mental disorders; depression
  and anxiety each ~**4–5%** of adults, lifetime any-disorder ~**30%** — stigma,
  cost, and under-resourced services keep most untreated [[src-con-adherence-stigma]].
...
prerequisite, not a feature. The Pelebox model's neutral "brown box" + private PIN
collection is instructive (see [[wiki/consumer-context/last-mile-addressing-logistics]]).

## Design implications

- **Multilingual by design:** at minimum offer the major home languages (isiZulu,
...
- **Borrow pharmacist trust:** make human/pharmacist oversight visible; signal
  "checked by a pharmacist"; offer a route to a real person for clinical questions.
- **Discreet by default:** neutral notification wording and packaging; never name a
  stigmatised condition in a message that others might see; assume **shared
  devices**.
- **Privacy as a headline promise**, not buried small print — POPIA-aligned consent,
  clear data use, personal PIN/OTP for collection.
- **Don't over-index on traditional healers** as a channel, but **respect
  pluralism**: people may combine biomedical and traditional care; non-judgemental
