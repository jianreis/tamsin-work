...
patient indifference** — which is precisely the design space a better scripting
...
- **Multi-morbidity:** HIV + hypertension/diabetes and HIV + TB are increasingly
  common — many patients are on **several concurrent chronic medicines**
  [[src-con-chronic-disease-burden]].
...
- **Stigma & disclosure fear:** especially HIV and mental health — fear of being
...
- **Bridge public and private:** retail pharmacies are already CCMDD points — a
...
- **Reduce stigma structurally** — neutral parcels, private PIN collection,
  non-judgemental, multilingual communication.
