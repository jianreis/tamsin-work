...
Critically, DAAs target **unintentional non-adherence** — forgetfulness and
...
- Interventions were **most effective when delivered in pharmacies**
  [[src-disp-conn-packaging-meta]] — i.e. the pharmacy is the right channel, and
...
[[src-disp-conn-packaging-meta]] — precisely the group often targeted — implying
