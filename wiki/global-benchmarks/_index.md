...
Each page ends with **`## What to borrow for SA`** and **`## What doesn't
transfer`**. When building a blueprint/journey step, pull the proven mechanism
from here, then check it against SA constraints in
[[wiki/sa-regulatory/_index|regulatory]], [[wiki/medical-schemes/_index|schemes]]
and [[wiki/consumer-context/_index|consumer context]] before committing.
