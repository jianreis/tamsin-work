...
**Trust is channel-specific, not general.** A patient may trust a face-to-face
pharmacist deeply, a clinic moderately, an app cautiously, and a courier with a box
of HIV medication not at all. Trust does not transfer automatically from the
counter to the chat window; each channel has to earn it on its own terms, and the
...
The **pharmacist is the trust anchor.** Automation can handle the bookkeeping, but
the human's visible clinical judgement, accountability and contactability are what
make the rest credible. The design rule is: never hide the human.

## In this vault
- [[wiki/consumer-context/language-literacy-and-trust|Language, literacy, trust & stigma]] — channel-specific trust and stigma in SA.
- [[wiki/ux-service-design/healthcare-service-design-patterns|Healthcare service-design patterns]] — dignity, consent, designing for vulnerability and anxiety.
...
processed at any step. See also [[wiki/concepts/identity-and-consent|identity & consent]].
