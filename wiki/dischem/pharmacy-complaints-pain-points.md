...
**The central meta-finding:** customers experience the **pharmacy as the
...
effort), **U4** (when a digital flow fails, fall back to a human with
...
the system has promised delivery. The report's **Priority 2**
[[src-dc-complaints-jan2025]].
...
top-of-licence), **S3** (compete on service, not price, the service
deficit here), **U5** (dignity and respectful, multilingual interaction, the rudeness
...
- **Resolved-only bias.** What does the *unresolved/abandoned* complaint tail look
  like, and is it worse for chronic dependence?
