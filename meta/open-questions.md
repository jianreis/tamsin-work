...
| open | ⚠️ SOTF programme facts unverified: the four ambitions (integrated healthcare, access, cost via Better Rewards, CX) are the project lead's framing (2026-09-01); MVP scope, launch dates, pilot stores, early results and post-launch feedback are entirely absent from the vault. | [[wiki/dischem/store-of-the-future-programme]] | **2026-09-01:** resolve via the intake list on the hub page - ingest programme definition, MVP scope, results and post-launch feedback as `src-sotf-...` notes, then reconcile against the pre-launch interview findings [[src-dc-store-future-interviews-2026]]. |
