...
| resolved 2026-09-07 | CCMDD cadence mismatch: parcels come every 2-3 months (2-month PUP delivery; 6-month supplies from April 2026 [[src-con-ccmdd-supply-cycle]]), not monthly | [[to-be-household-repeat-moments]] (v3.11 - renumbered in the main merge), [[sipho-whatsapp-flow]] (v4) | #09 fixed 2026-09-06; #11 re-synced 2026-09-07 - "collected monthly" gone, the parcel mentioned only when it lands or is due. |
...
| open | SAPC GPP wording on "re-use of containers" and on patient-returned medicine (may returned packaging or medicine be re-dispensed or refilled?) | [[wiki/digital-transformation/zero-waste-pharmacy-packaging]], [[src-sapc-bn100-disposal-destruction]] | SAPC PDFs blocked to automated fetch 2026-09-07; position inferred from BN 100 (returns go to recorded destruction) plus the Australian RUM and US NABP rules. Needs a direct read and quote before the no-waste note claims anything about refilling. |
