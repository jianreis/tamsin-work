...
| researched | ⚠️ SOTF programme facts: ambitions, design decisions, MVP scope and launch record now verified against six ingested programme documents (`src-sotf-*`). Still missing: early results against the 8 SOTF success metrics, post-launch customer feedback, the delivery-process training doc (supplied file was a duplicate of online-collections), and the Irene-vs-Melrose comparison. | [[wiki/dischem/store-of-the-future-programme]] | **2026-09-01, part-resolved:** Aug 2025 strategy, Nov 2025 SteerCo pack + decisions, Feb 2026 Melrose workshops + TDC&Co design, May-Jul 2026 training pack ingested. Key finding logged on the hub page: concept validated by SteerCo (Nov 2025) before the customer study (Jan 2026); Feb 2026 MVP workshops don't cite it. Tensions to test with post-launch feedback: 10-min late rule vs 9/12 forgiveness ask, POS-only payment to 2028, no direct store WhatsApp. |
