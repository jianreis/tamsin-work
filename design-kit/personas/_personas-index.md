...
Research-backed personas spanning the South African pharmacy customer base, plus
...
## Persona → segment → dominant JTBD → primary channel

| # | Persona | Segment | Dominant JTBD | Primary channel |
|---|---|---|---|---|
| 1 | Nomvula — insured chronic, multimorbid | Insured | Keep chronic meds flowing automatically (+ no co-pay surprise) | App / WhatsApp + delivery |
...
## How to use
For each persona × scenario, pick the **dominant job** from [[jtbd-library]], then
design the journey to nail that job's expected outcome while resolving the pains
that block it (cite the [[as-is-prescription-journey]] and the relevant
