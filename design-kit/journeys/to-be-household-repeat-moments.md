...
| P4 In hand | In hand when promised, or told early | The morning message (window on track + the handover QR with the how-to and a backup PIN, v3.5) · I track it to my door ⭐ · I check it, with help one tap away (contents list; photo -> immediate human callback) (v3.1; "If the day doesn't suit me" moved to P3 as Fulfilment flexibility, v3.5) | The payday reminder · I pay, and the locker opens ⭐ (pay at counter, then PIN opens locker) · I check it before I go home (photo -> human callback, in language; locker outage lives in the ∥ band, fallback activity dropped) (v3.1) | "I could track it from Dis-Chem's door to mine" ⭐ (both) | Out for delivery - then nothing (verbatim, complaints) · Nobody picks up (verbatim, sentiment) · Too-precise promises (verbatim, SOTF) |
