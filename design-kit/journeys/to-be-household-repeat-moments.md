...
sources: [src-dc-complaints-jan2025, src-dc-social-media-research-2025, src-dc-store-future-interviews-2026, src-dc-call-reminder-walkthrough-2026, src-dc-e2e-script-journey-friction-summary, src-dc-dispensary-managers-survey-2025]
created: "2026-07-17"
updated: "2026-09-08"
---
...
v3.11 (2026-09-06, agreed with Tamsin, cash side, driven by the
Sipho persona household expansion): (1) Sipho's wife **Thandi** joins the
standing order with her repeat contraceptive; the kids (14, 12) and nephew
Lwazi (17) are part of the household but are NOT signed up - anything acute
they need rides a P2 addition, and the P2 mechanics themselves are unchanged.
(2) **Discreet by default inside the household**: on any surface both adults
can see (the shared thread, the price breakdown, the contents list), her
medicine is named by owner - "Thandi's repeat" - never by product; the
product name lives on her own phone, her own reminders and the pack itself.
(3) The date logic extends, honestly: her pack is a fixed monthly cycle that
cannot be broken for a short fill, so aligning her to the 28th takes a
**once-off extra month of her medicine**, priced before he agrees; his own
tablets still move by the v3.8 loose-tablet top-up. Both once-off costs ride
the first order, and the read-back shows them next to a normal month.
(4) **CCMDD cadence corrected**: the mother's parcel comes **every two to
three months on the programme's cycle**, not monthly, and its exact date is
hard to predict [[src-con-ccmdd-ndoh]] - so it cannot be lined up with
anything and is not offered a sync; the chat tracks it, mentions it only
when a parcel actually lands or is due, and the P1 notice no longer implies
a monthly parcel. "Two dates, one memory" survives as a title and sharpens
as a fact: the household's one Dis-Chem date (the 28th) plus the programme's
own rhythm. (5) The pain-point sweep for family/contraceptive collection
found nothing in the three research pages (the SOTF caregiving-load signal
stands, already cited); existing pains stay, no pain invented.
v3.12 (2026-09-08, agreed with Tamsin, insured side, from the executive
run-throughs): (1) P0 "One date for everyone" was missing **Lethabo's
asthma pump** - the two activities before it name four people, the sync
named three. He is back in, and his pump follows the v3.11 whole-pack
physics: an inhaler can't be topped up by a few days, so his move is one
extra pump, once. (2) The **Script Sync sequence** is now a standing rule
(below) and the insured activity is rewritten to walk it in order - anchors
surfaced first, least-cost day suggested, any day the customer likes priced
on request. The old copy read as if the pharmacist chose the household's
date; under the rule the app suggests and Nomvula decides. The cash side
already followed the sequence (v3.8/v3.11) and is unchanged. (3) Read-back
and P1 breakdown take the light plural - "once-off top-ups" - now that two
mechanics ride the first order.

**Script Sync sequence (standing rule, v3.12 - applies to every economy and
any journey that syncs dates).** (A) **Surface the anchors first**: anything
that can't move is named plainly, once, with no clinical argument in the
customer's copy; the customer can plan around it or leave it out of the
sync. (B) **Suggest the day that costs the least top-up**, and say why. (C)
**The customer may pick any day** and see what it would cost. Commitment
only after the price is shown. The anchor is never the rule of the
medicine - it is the reason the suggestion is what it is.
v3.13 (2026-09-08, agreed with Tamsin, cash side): "Two dates, one memory"
rewritten to walk the same A-B-C. The mother's parcel is the anchor (A): it
can't move, so the chat offers to line the rest up and suggests her expected
date, around the 18th (B). That sits before payday, so Sipho leaves hers
separate and puts his and Thandi's on the 28th (C). Thandi's pack can't be
broken, so her first order carries two packs, one to tide her over to the
28th; his tablets take the small once-off top-up. Prices before he says yes.
Downstream phases unchanged - the 28th holds.
v3.14 (2026-09-08, Aliyah's instruction relayed by Tamsin, cash side): the
**medicine-only restriction on the locker route is out** - anything on
Dis-Chem's shelves can ride in the standing order, cash as well as insured.
P2 cash "I can add other medicine" becomes "I can add to the order"; "I add
what we need, in the chat" names the **four ways in** Aliyah asked for
(specials on what you usually buy served first, then: type a product, snap a
photo of your shopping list, browse this week's specials, continue on the
app or web). Behind-the-line loses the medicine-only filter; the retail
add-on and shopping-list-photo constructs are ⚠️ assumptions (punchlist 21).
Parcel physics for general retail through a bank locker is an open point,
logged there, not in the copy.
...
|---|---|---|---|---|---|
| P0 Signing up (once) | Set up once, on my terms, remembered every month after | I add my household · I add their medicines · One date for everyone (Script Sync walked in the standing A-B-C order, v3.12: Zanele's script surfaced as the anchor - plan around or leave her out - month-end suggested as least-cost, any other day priced on request; Nomvula + Grace top up tablets, Lethabo's pump is one extra pump once, v3.3/v3.12) · I choose how it reaches us (channel only - time is proposed in each month's notice; incl. the Made-for-Me dose-pack opt-in) · I choose how I pay (incl. the rejection rule: check first or charge-and-continue) · I check it once, and confirm (read-back includes the first month's cost with the once-off top-ups, v3.7/v3.12) (v3.1) | I start the conversation (origin story: invited by message after an in-store collection, pharmacist points to WhatsApp, v3.6) · I add my household (Sipho + Thandi + his mother, v3.11; the kids and Lwazi are not signed up - acute needs ride P2 additions; Thandi's medicine named by owner on shared surfaces, v3.11) · Two dates, one memory (A-B-C, v3.13: the mother's parcel is the anchor that can't move; the chat offers to line the rest up and suggests her expected date, around the 18th; he declines - before payday - leaves hers separate and picks the 28th for his and Thandi's; his tablets take the small once-off loose-tablet top-up, v3.8; Thandi's pack can't be broken, so her first order carries two packs, one to tide her over, v3.11/v3.13; both once-offs ride the first order; payday stays his logic, never a date the service is told, v3.8) · I choose how it reaches us (locker at Capitec - no Dis-Chem nearby; bank-trip logic moved here from the opener, v3.6; instruction language per member) · I choose how I pay (cash on collection opens the locker) · I confirm (v3.1) | "I told them once how I want it" (both, on confirm) | You type it again (verbatim, sentiment) · The digital front door is broken (verbatim, complaints) |
| P1 Repeats are due | Everyone's medicine keeps flowing on its own; complete clarity on the cost | The message arrives · I see the costs, clearly broken down (first-month top-ups as their own lines in the breakdown, v3.7/v3.12) · It keeps going - unless I say otherwise (first-person register, v3.1) | The message arrives (the household's Dis-Chem order - his tablets + Thandi's repeat, v3.11; the mother's parcel mentioned only when one has landed or is due on the programme's two-to-three-month cycle, never implied monthly, v3.11) · I see the price before I travel (his tablets + Thandi's repeat as an owner-named line - no product name on the shared surface, v3.11; no CCMDD line, v3.4; moment why carries the counter dignity, v3.6) · It keeps going - unless I say otherwise, with the person-in-my-language fallback on its own line (v3.1) | "My medicine ordered itself" ⭐ · "The only thing I ever bought blind - not anymore" ⭐ (both economies) | The re-order dance (verbatim, complaints) · Money is a mystery until the end (verbatim, complaints) |
| P2 Adding to the order | The delivery carries the rest of the list | My order stays open · I add the household's shop (whole store browsable/searchable; suggestions + specials as the helper, not the boundary, v3.5) | I can add to the order (anything on Dis-Chem's shelves - the medicine-only restriction removed, v3.14) · I add what we need, in the chat (specials on what we usually buy first, then the four ways in: type a product, snap a shopping-list photo, browse this week's specials, continue on the app or web - v3.14; chat-commerce demo: clarifying question, priced options; v3.1) | "While we're here... - without going anywhere" (insured only; the cash addition agreed to carry no moment) | none in the research - honest note instead |
| P3 Checked and packed | Certainty it's exactly right, for everyone | Picked and checked (status lists the checks itself, named pharmacist; moment here) · Packed and sealed (no credential at sealing, v3.5) · Fulfilment flexibility (until the day before: shift day/window or switch to collection; moved from P4's "If the day doesn't suit me", v3.5) | Picked and checked (the household's Dis-Chem order - his tablets and Thandi's repeat checked against each other; the programme packs the mother's, v3.4/v3.11; moment here) · Packed and sealed (no PIN at sealing, v3.6) · Fulfilment flexibility (shift the date if payday moves, switch locker / store / costed delivery, until the day before, v3.6) | "Every check ran before it left the building" (both) | The short pack, discovered at home (verbatim, complaints) · Errors read as safety threats (sentiment) |
...
| 2 | **Recurring counter and collection failures** - parcels not truly ready on arrival, unprepared ("unprepared" added by Tamsin, 2026-09-03), incomplete or incorrect, rebuilt live at the counter; visible, time-consuming, confidence-eroding. | repeat-reminder walkthrough (packages not ready · incorrect items · package search) · complaints (cluster C) · sentiment (collections ~93% negative). |
| 3 | **Responsibility without control** *(retitled from "Low customer autonomy" on Tamsin's instruction, 2026-09-03 - the outcome stays the customer's responsibility while the levers sit with a system that is both intrusive and erratic)* - repeated calls and reminders to prompt action or re-clarify what was already provided; administrative not clinical, intrusive not supportive; control sits with the system and call centre. And the flip side (added 2026-08-19, agreed): autonomy isn't only taken away - customers who try to self-manage digitally hit app and WhatsApp re-order flows that loop and dead-end, so control defaults to the call centre because the self-service alternative is broken. Extended 2026-08-21 (agreed, staff-survey evidence): the contact isn't even dependable - the same estate produces complaints about being called too much AND about never being called, months where the repeat silently isn't processed, and stopped-but-still-active repeats that keep triggering SMSes and dispensing. The customer ends up supervising a service that was sold as running itself. Extended 2026-09-03 (Tamsin's observation, folded in as the theme's closing register): the reminder service has lost the concierge feel it used to have - agents rather than pharmacists, reminders that don't know what was already collected in store, and no clean way to switch any of it off. Evidence mapping: agents-not-clinicians = walkthrough (administrative, not clinical; agents not identifying themselves); can't quit = sentiment (harassment after opt-out); not synced to in-store collections = staff survey + walkthrough (calls after new scripts already submitted; orders processed at the wrong store). *(The 2026-08-21 framing note proposing this retitle is resolved: Tamsin took it on 2026-09-03.)* | repeat-reminder walkthrough (phone reminder experience) · sentiment (comms overload / harassment after opt-out) · complaints (cluster A: the self-service alternative loops and dead-ends) · dispensary-managers survey ("some complain they DO get called… others that they DONT"; unprocessed repeats; stopped-but-active repeats). |
| 4 | **Opaque order status** - no clear capture confirmation (call orders), progress between submission, preparation and readiness invisible; customers can't confidently plan collection or delivery. Extended 2026-09-03 (Tamsin, agreed): opacity starts at submission - a script the doctor sends, or the customer emails, has no receipt; the only ways to learn whether Dis-Chem got it are phoning or arriving at the counter. And delivery communication is the most erratic stretch - sometimes updates come, sometimes nothing, and promises are missed on stock without a word. | e2e friction synthesis (no-progress-visibility through-line) · repeat-reminder walkthrough (unreliable communication) · SOTF ("waiting is fine - being unsure isn't") · script-journey IDIs ("customers can't tell if Dis-Chem received it… no confirmation system") · collections/deliveries IDIs (no single confirmation loop; status-blur; windows vary by store) · complaints (cluster B: "out for delivery… did not receive it"). |
| 5 | **Inconsistent experience across channels** - confirmation and progress messages differ by channel; each repeat order can feel different even when nothing changed; customers fall back to calls and in-person checks. Extended 2026-09-03 (Tamsin, agreed): the inconsistency runs along two more axes - month to month (wording, forms and steps change constantly; continuous improvement inside reads as instability outside) and within one order (placed on the app, updates on WhatsApp or SMS). Mechanism stated honestly: many channels are a person in the store answering manually, so consistency isn't something the current service can promise. | e2e friction synthesis (stages 1-2) · complaints (no single owner across app/WhatsApp/store/call-centre) · repeat-reminder walkthrough (Adherence Centre vs store sync) · dispensary-managers survey ("constantly being improved/updated… several errors before the system works properly again"; channels manned manually, no permanent staff). |
| 6 | **Broken telephone between departments** *(added 2026-09-03, Tamsin's observation confirmed as a distinct theme)* - the call centre, the Adherence Centre and the store speak with different voices: what the agent promised on the phone isn't what the counter knows, the store often has no record of what was communicated, and staff arbitrate the dispute "as a 3rd party… without any evidence". The customer becomes the messenger between departments of the same company. | repeat-reminder walkthrough ("stores frequently don't know what the Adherence Centre has communicated"; call centre and dispensary "aren't in sync") · dispensary-managers survey ("he says - she says problems with call centre"; the 3rd-party-without-evidence line). |
| 7 | **Money is a mystery** *(added)* - unexpected levies, co-payments discovered at collection, funds depleted without warning, scheduled-medicine pricing that reads as arbitrary between stores; nobody explains the levy even after payment. Mechanism added 2026-08-21 (agreed, staff-survey evidence): behind the surprises sit co-payments never discussed by the call centre before dispensing, claims routed to the wrong benefit, and PMB (prescribed-minimum-benefit) registration customers assume is automatic when it isn't. | complaints (cluster E, Priority 5) · repeat-reminder walkthrough (co-payments card + Tamsin's after-payment sticky) · e2e friction synthesis · dispensary-managers survey (co-pays not discussed; benefit mis-routing; PMB assumption). |
| 8 | **You find out last** *(rewritten 2026-09-03 from "A failure ends the journey" on Tamsin's feedback - the "kills the order" metaphor replaced by what actually happens)* - when something goes wrong (a stock-out, a claim snag, a schedule restriction), nobody says so: the customer discovers the problem only when the delivery is late, the parcel is wrong, or they phone to chase. Nothing surfaces stock or scheduling rules before the order is taken, so the plan-B lands on the customer after they've committed. And chasing means phoning into a void - a single unrecovered failure is where customers defect. | complaints (cluster B: notified "out for delivery", never arrived; exception aborts silently) · dispensary-managers survey (out-of-stock items dispensed without checking or communicating; adherence "does not check for out of stocks") · e2e friction synthesis (stage 1: no visibility on stock before submission) · sentiment ("called 4 different dispensaries… nobody is picking up"; defection at R460 more). |
| 9 | **The script expires before the customer expects it to** *(added 2026-08-21, agreed - staff-survey sweep)* - a repeat script is valid for six months from the date of writing, but customers read the repeat count as the promise ("they want to see six repeats on the label"); the last repeat or the expiry is often not communicated until the counter, and the renewal lands as a surprise errand ("why must they get script every 6 months"). The repeat journey ends on a wall nobody warned them about. | dispensary-managers survey (the most repeated repeat-journey complaint in the staff data) · complaints (cluster D: "I've been trying to renew my prescription and the nurse doesn't know what to do"). |
...
Provenance addendum (2026-08-21): themes 8 and the theme-3/theme-6
extensions come from the sweep against
...
- **Sipho's household (added 2026-09-06, agreed with Tamsin):** wife **Thandi**
  (41, repeat oral contraceptive - on the standing order, named by owner on
  every shared surface), his mother (chronic, CCMDD - parcel every two to
  three months on the programme's cycle, tracked but never managed or synced),
  two children (14, 12) and nephew **Lwazi** (17) - the last three not signed
  up; their acute needs ride P2 additions. See
...
- Friction-panel nuance candidate still open from the collections/deliveries
  IDIs: a post-handover support void exists on both channels (no built-in
  way to ask a question after collection/delivery) - evidenced as a gap the
  report names, not a complaint customers voiced. Tamsin to call whether it
  earns panel copy. (The other candidate - status-blur and delivery-comms
  evidence into theme 4 - was folded in on 2026-09-03 with Tamsin's
  feedback round.)
- ~~Theme 3 retitle~~ Resolved 2026-09-03: Tamsin took the "Responsibility
  without control" retitle. The collections/deliveries IDIs' mental-models
  chapter independently supported it (customers safeguard "a system they
  don't fully control"; "digital submission shifts effort, not
  responsibility").
