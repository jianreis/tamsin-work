...
so_what: A scan-to-retrieve token (no PIN, any phone) with a fresh code per repeat gives SA a low-friction e-script design with anti-double-dispense baked in.
facts:
